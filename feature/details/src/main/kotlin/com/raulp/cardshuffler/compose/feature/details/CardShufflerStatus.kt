...
//@Composable
//internal fun FlashcardInfo.toCardShufflerStatusList(): ImmutableList<CardShufflerStatus> {
...
//      progress = attack / FlashcardInfo.MAX_ATTACK.toFloat(),
...
//      progress = defense / FlashcardInfo.MAX_DEFENSE.toFloat(),
...
//      progress = speed / FlashcardInfo.MAX_SPEED.toFloat(),
...
//      progress = exp / FlashcardInfo.MAX_EXP.toFloat(),
